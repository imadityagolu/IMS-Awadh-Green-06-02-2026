        ...
        tooltip: {
          ...
          callbacks: {
            label: function (context) {
              ...
              return `${label}: ₹${actualAmount.toLocaleString()} (${orderCount} orders)`;
            }
          }
        },
      },
      scales: {
        ...
        y: {
          ...
          ticks: {
            ...
            callback: (value) => `₹${value}k`, // Show as ₹Xk
          },
        },
      },
    };
        ...
        tooltip: {
          callbacks: {
            label: function (context) {
              ...
              return `Retail: ₹${actualAmount.toLocaleString()}`;
            }
          }
        },
      },
              ...
              <div className="d-flex flex-column " style={{ gap: "11px" }}>
                ...
                <div className="d-flex align-items-end gap-2">
                  <h5
                    ...
                    style={{ fontSize: "22px", color: "#0E101A" }}
                  >
                    ₹{Math.round(retailSalesData.totalSales).toLocaleString()}
                    <span style={{ color: "grey", fontSize: "20px" }}>
                    ...
                    topSellingProducts.map((p, index) => (
                      ...
                      >
                        ...
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
                          ...
                          >
                            ₹{p.sellingPrice?.toLocaleString()*p.sellQuantity}
                          </div>
                      {/*  */}
                        </div>
                      </div>
