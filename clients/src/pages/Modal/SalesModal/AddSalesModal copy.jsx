                          ...
                          <div className="row">
                            <div className="col-md-12">
                              <div className="mb-3">
                                ...
                                {companyImages ? (<div className="logo-image">
                              ...
                              <tr key={product._id}>
                                <td>
                                  ...
                                  <small className="text-muted">
                                    Available Stock: {d.remainingQty} {product.unit} (Before Sale: {d.availableQty})
                                  </small>
                                </td>
                                ...
                                <td>₹{d.unitCost.toFixed(2)}</td>
                                <td className="fw-semibold text-success">₹{d.lineTotal.toFixed(2)}</td>
                                <td>
                    ...
                    <div className="col-md-7">
                      ...
                      <div className="col-md-5 ms-auto mb-3">
                        <div className="d-flex justify-content-between align-items-center border-bottom mb-2 pe-3">
                          ...
                          <p className="text-dark fw-medium mb-2">₹ {amount.toFixed(2)}</p>
                        </div>
                        ...
                        <div className="d-flex justify-content-between align-items-center  mb-2 pe-3">
                          ...
                          <p className="text-dark fw-medium mb-2">₹ {shippingCost.toFixed(2)}</p>
                        </div>
                        <div className="d-flex justify-content-between align-items-center  mb-2 pe-3">
                          <p className="mb-0">Labour Cost</p>
                          <p className="text-dark fw-medium mb-2">₹ {labourCost.toFixed(2)}</p>
                        </div>
                        <div className="d-flex justify-content-between align-items-center border-bottom mb-2 pe-3">
                          <p className="mb-0">Discount</p>
                          <p className="text-dark fw-medium mb-2">₹ 00</p>
                        </div>
                        <div className="d-flex justify-content-between align-items-center mb-2 pe-3">
                          <h5>Total Amount</h5>
                          <h5>₹ {Number.isFinite(grandTotal)
